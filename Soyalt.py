...
client = commands.Bot(description="Here is some command for you", command_prefix=commands.when_mentioned_or("sk!"), pm_help = False)
...
async def on_ready():
	...
	return await client.change_presence(game=discord.Game(name='for sk! ')) #add_your_bot_status_here
...
async def botinvite(ctx):
    ...
    await client.say('https://discordapp.com/api/oauth2/authorize?client_id=518672070377209857&permissions=8&scope=bot NOTE: THIS IS NOT PREMIUM BOT YOU NEED PREMIUM SO ASK OWNER AND PREMIUM IS FREE ')
